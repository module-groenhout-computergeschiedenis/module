...
int main()
{
    ...
    // OEFENING: probeer wat de binaire waarden zijn van decimale getallen naar jouw keuze.

    // OEFENING: toon de binaire en hexadecimale representatie van decimale getallen van 0 tem 15.
    // Doe dit in een lus...
    // for(char n=0; ...) {
    //    ...
    // }

...
void paint() {
    ...
    for (char x = 0; x < 40; x++) {
        *(screen + 40 * 0 + x) = block[bitmap[40 * 0 + x]];
        *(screen + 40 * 1 + x) = block[bitmap[40 * 1 + x]];
        *(screen + 40 * 2 + x) = block[bitmap[40 * 2 + x]];
        *(screen + 40 * 3 + x) = block[bitmap[40 * 3 + x]];
        *(screen + 40 * 4 + x) = block[bitmap[40 * 4 + x]];
        *(screen + 40 * 5 + x) = block[bitmap[40 * 5 + x]];
        *(screen + 40 * 6 + x) = block[bitmap[40 * 6 + x]];
        *(screen + 40 * 7 + x) = block[bitmap[40 * 7 + x]];
        *(screen + 40 * 8 + x) = block[bitmap[40 * 8 + x]];
        *(screen + 40 * 9 + x) = block[bitmap[40 * 9 + x]];
        *(screen + 40 * 10 + x) = block[bitmap[40 * 10 + x]];
        *(screen + 40 * 11 + x) = block[bitmap[40 * 11 + x]];
        *(screen + 40 * 12 + x) = block[bitmap[40 * 12 + x]];
        *(screen + 40 * 13 + x) = block[bitmap[40 * 13 + x]];
        *(screen + 40 * 14 + x) = block[bitmap[40 * 14 + x]];
        *(screen + 40 * 15 + x) = block[bitmap[40 * 15 + x]];
        *(screen + 40 * 16 + x) = block[bitmap[40 * 16 + x]];
        *(screen + 40 * 17 + x) = block[bitmap[40 * 17 + x]];
        *(screen + 40 * 18 + x) = block[bitmap[40 * 18 + x]];
        *(screen + 40 * 19 + x) = block[bitmap[40 * 19 + x]];
        *(screen + 40 * 20 + x) = block[bitmap[40 * 20 + x]];
        *(screen + 40 * 21 + x) = block[bitmap[40 * 21 + x]];
        *(screen + 40 * 22 + x) = block[bitmap[40 * 22 + x]];
        *(screen + 40 * 23 + x) = block[bitmap[40 * 23 + x]];
        *(screen + 40 * 24 + x) = block[bitmap[40 * 24 + x]];
    }
}
...
void plot(char x, char y, char c) {
    ...
    */
    ...
    unsigned int i = (unsigned int)iy * 40 + ix;

...
int main() {
    ...
    // OPLOSSING 03.1:
    *(screen+00) = ...;  // 0b0001 = blokje rechts onder
    *(screen+02) = ...;  // 0b0000 = geen enkel blokje
    *(screen+04) = ...;  // 0b0001 = blokje rechts onder
    *(screen+06) = ...;  // 0b0010 = blokje links onder
    *(screen+08) = ...;  // 0b0011 = blokje rechts en links onder
    *(screen+10) = ...;  // 0b0100 = blokje rechts boven
    *(screen+12) = ...;  // 0b0101 = blokje rechts boven en rechts onder
    *(screen+14) = ...;  // 0b0110 = blokje rechts boven en links onder
    *(screen+16) = ...;  // 0b0111 = blokje rechts boven en links en rechts onder
    *(screen+18) = ...;  // 0b1000 = blokje links boven
    *(screen+20) = ...;  // 0b1001 = blokje links boven en rechts onder
    *(screen+22) = ...;  // 0b1010 = blokje links boven en links onder
    *(screen+24) = ...;  // 0b1011 = blokje links boven en links en rechts onder
    *(screen+26) = ...;  // 0b1100 = blokje links en rechts boven
    *(screen+28) = ...;  // 0b1101 = blokje links en rechts boven en rechts onder
    *(screen+30) = ...;  // 0b1110 = blokje links en rechts boven en links onder
    *(screen+32) = ...;  // 0b1111 = overal blokjes!

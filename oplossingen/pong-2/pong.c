...
int main()
{
    ...
    const char wall_left = 1;
    const char wall_right = 158;
    const char wall_top = 1;
    const char wall_bottom = 48;
    ...
    unsigned int fp_x = 2 * 0x100;
    unsigned int fp_y = 24 * 0x100;
    ...
    signed int dx = 0b10000000;
    signed int dy = 0b01000000;
    ...
    while (ch != 'x')
    {
        ...
        char wall_min = wall_top;
        char wall_max = wall_bottom - wall_size;
